...
_LOG = setup_logging("catalog-items")

app = FastAPI(title="catalog-items", version="1.0.0")
...
SERVICE_NAME = os.environ.get("SERVICE_NAME", "catalog-items")
VAULT_CONFIGURED = bool(os.environ.get("VAULT_ADDR"))


@app.get("/")
def root():
    return {"service": "catalog-items", "version": "1.0.0", "vault_configured": VAULT_CONFIGURED}
...
def readyz():
    ...
    return JSONResponse(
        ...
        content={"service": "catalog-items", "vault": health},
    )
